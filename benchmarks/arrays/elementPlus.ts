...
suite(
  [
    { title: "bun plus of 1000", fn: () => bunFn(arr1000, arr1000_2) },
    {
      title: "julia plus of 1000",
      fn: () => juliaFn(arr1000, arr1000_2),
    },
    {
      title: "bun plus of 10000",
      fn: () => bunFn(arr10000, arr10000_2),
    },
    {
      title: "julia plus of 10000",
      fn: () => juliaFn(arr10000, arr10000_2),
    },
    {
      title: "bun plus of 100000",
      fn: () => bunFn(arr100000, arr100000_2),
    },
    {
      title: "julia plus of 100000",
      fn: () => juliaFn(arr100000, arr100000_2),
    },
    {
      title: "bun plus of 1000000",
      fn: () => bunFn(arr1000000, arr1000000_2),
    },
    {
      title: "julia plus of 1000000",
